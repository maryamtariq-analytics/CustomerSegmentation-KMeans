...
st.write("Segmenting customers based on their **personalities (demographic)** and the **amount spent on products"
         " (behavioural)** in order to gain a better understanding of company's customer's personalities and "
         "habits to effectively design the business and marketing strategies.")
...
data = pd.read_csv(r"C:\Users\maria\OneDrive\Desktop\DataSets\MarketingCampaign-CustomerSegmentation.csv", sep='\t')
st.write(data)
